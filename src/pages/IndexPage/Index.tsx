...
function Index() {
  return (
    ...
    <section className=" flex gap-4 w-144 m-auto ">
    ...
    <section className="grid grid-cols-3 grid-rows-3 gap-4 w-144 m-auto">
    {item.map((item,index)=>(
      <div className=" grid grid-cols-4 bg-slate-600 w-96 h-80 my-8 rounded-lg" key={index}>
        <div className="">
